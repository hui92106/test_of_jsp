...
/**
 * @ClassName: FixedAssetBO
 * @Description: Description of this class
 * @author <a href="mailto:donghui@szlongtu.com">董晖</a>于 2016-1-7 下午1:58:48
 */

public class FixedAssetBO extends GcfrBO {
	
    /**
     * fixedAssetDao.
     */
    @Resource(name = "gcfr.baseset.fixedasset.FixedAssetDAO")
    private FixedAssetDAO fixedAssetDao = null;
    ...
    public RecordSet getData() throws IOException {
    	List<Map<String, Object>> dataList = this.fixedAssetDao.queryByType();
    ...
    public void saveAsset(Map<String, Object> map) throws AppException {
        ...
        if ( null != insertList && insertList.isEmpty()) {
            ...
            this.fixedAssetDao.insertFixedAsset(insertMap);
        }
        ...
        if (null != updateList && updateList.isEmpty()) {
            ...
            this.fixedAssetDao.updateFixedAsset(updateMap);
        }
        ...
        if (null != delList && delList.isEmpty()) {
            ...
            this.fixedAssetDao.delFixedAsset(delMap);
        }
    }
}
