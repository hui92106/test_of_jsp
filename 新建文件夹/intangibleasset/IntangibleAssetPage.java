...
public class IntangibleAssetPage extends AbstractPageService {
    ...
    @PageConsole(appid = "gcfr", url = "/gcfr/intangibleasset", page = "/gcfr/template/gcfr_default.jsp", config = "{header:[gcfrheader, gcfrmenu, toolbuttonbar],"
            ...
            @PageComponent(serviceid = "gcfr.baseset.intangibleasset.IntangibleAssetService", id = "gcfr_baseset_intangibleasset_IntangibleAssetService") })
    public Map intangibleAsset(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
        return config;
    }
}
